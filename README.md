...
#### Discrete vs. Continuous Time Representations
Once we agree on a time scale of interest and an origin/start, our data model must decide _when_ it should record the physical state of the system. 